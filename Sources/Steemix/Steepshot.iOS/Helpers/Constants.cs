...
namespace Steepshot.iOS
{
    public class Constants
    {
        ...
        public static string Currency => BaseViewController.Chain == KnownChains.Steem ? "$" : "₽";
        ...
        public static string Tos => BaseViewController.User.IsDev ? "https://qa.steepshot.org/terms-of-service" : "https://steepshot.org/terms-of-service";
        public static string Pp => BaseViewController.User.IsDev ? "https://qa.steepshot.org/privacy-policy" : "https://steepshot.org/privacy-policy";
