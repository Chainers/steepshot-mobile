...
namespace Steepshot.iOS
{
    public partial class CommentsViewController : BaseViewController
    {
        ...
        private CommentsTableViewSource _tableSource = new CommentsTableViewSource();
        ...
        public async Task CreateComment()
        {
            try
            {
                ...
                var reqv = new CreateCommentRequest(User.SessionId, PostUrl, commentTextView.Text, commentTextView.Text);
