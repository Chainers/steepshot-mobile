...
namespace Steepshot.iOS
{
    public partial class FeedViewController : BaseViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            _navController = NavigationController; //TabBarController != null ? TabBarController.NavigationController : NavigationController;
        ...
        private void ToogleDropDownList()
        {
            if (_dropdown.Frame.Y < 0)
            {
                UIView.Animate(0.3, 0, UIViewAnimationOptions.CurveEaseIn,
                    () =>
                    {
                        _dropdown.Frame = new CGRect(_dropdown.Frame.X, _dropDownListOffsetFromTop, _dropdown.Frame.Width, _dropdown.Frame.Height);
            ...
            else
            {
                UIView.Animate(0.2,
                    () =>
                    {
                        _dropdown.Frame = new CGRect(_dropdown.Frame.X, _dropdown.Frame.Y - _dropdown.Frame.Height, _dropdown.Frame.Width, _dropdown.Frame.Height);
        ...
        private void SetNavBar()
        {
            ...
            var barHeight = _navController.NavigationBar.Frame.Height;
            ...
            _navController.NavigationBar.BarTintColor = Constants.NavBlue;
        }
        ...
        private UIView CreateDropDownList()
        {
            ...
            view.Frame = new CGRect(0, _dropDownListOffsetFromTop - _navController.NavigationBar.Frame.Width, _navController.NavigationBar.Frame.Width, trendingButton.Frame.Bottom);
