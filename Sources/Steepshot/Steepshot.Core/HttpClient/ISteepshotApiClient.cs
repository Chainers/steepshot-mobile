...
namespace Steepshot.Core.HttpClient
{
    public interface ISteepshotApiClient
    {
        ...
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetUserPosts(UserPostsRequest request, CancellationToken ct);
        ...
        ///            Cookie: sessionid=h0loy20ff472dzlmwpafyd6aix07v3q6
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetUserRecentPosts(CensoredNamedRequestWithOffsetLimitFields request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetPosts(PostsRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetPostsByCategory(PostsByCategoryRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<SearchResponse<SearchResult>>> GetCategories(OffsetLimitFields request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<SearchResponse<SearchResult>>> SearchCategories(SearchWithQueryRequest request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<SearchResponse<UserFriend>>> SearchUser(SearchWithQueryRequest request, CancellationToken ct);
