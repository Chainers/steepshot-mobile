...
namespace Steepshot.Core.HttpClient
{
    public interface ISteepshotApiClient
    {
        ...
        Task<OperationResult<VoteResponse>> Vote(VoteModel model, CancellationToken ct);

        Task<OperationResult<VoidResponse>> Follow(FollowModel model, CancellationToken ct);

        Task<OperationResult<VoidResponse>> LoginWithPostingKey(AuthorizedModel model, CancellationToken ct);

        Task<OperationResult<CommentResponse>> CreateComment(CommentModel model, CancellationToken ct);

        Task<OperationResult<CommentResponse>> EditComment(CommentModel model, CancellationToken ct);

        Task<OperationResult<ImageUploadResponse>> CreatePost(UploadImageModel model, UploadResponse uploadResponse, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetUserPosts(UserPostsModel model, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetUserRecentPosts(CensoredNamedRequestWithOffsetLimitModel request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetPosts(PostsModel model, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetPostsByCategory(PostsByCategoryModel model, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> GetPostVoters(VotersModel model, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/post/@joseph.kalu/cat636203355240074655/comments HTTP/1.1
        /// </summary>
        Task<OperationResult<ListResponse<Post>>> GetComments(NamedInfoModel model, CancellationToken ct);


        Task<OperationResult<UploadResponse>> UploadWithPrepare(UploadImageModel model, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<SearchResult>>> GetCategories(OffsetLimitModel request, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<SearchResult>>> SearchCategories(SearchWithQueryModel model, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/user/joseph.kalu/info HTTP/1.1
        /// </summary>
        Task<OperationResult<UserProfileResponse>> GetUserProfile(UserProfileModel model, CancellationToken ct);
        ...
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> GetUserFriends(UserFriendsModel model, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/post/spam/@joseph.kalu/test-post-127/info HTTP/1.1
        /// </summary>
        Task<OperationResult<Post>> GetPostInfo(NamedInfoModel model, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET GET https://steepshot.org/api/v1/user/search?offset=gatilaar&amp;limit=5&amp;query=aar HTTP/1.1
        /// </summary>
        Task<OperationResult<ListResponse<UserFriend>>> SearchUser(SearchWithQueryModel model, CancellationToken ct);

        /// <summary>
        ///     Examples:
        ///     1) GET GET https://steepshot.org/api/v1/user/pussyhunter123/exists HTTP/1.1
        /// </summary>
        Task<OperationResult<UserExistsResponse>> UserExistsCheck(UserExistsModel model, CancellationToken ct);


        Task<OperationResult<VoidResponse>> DeletePostOrComment(DeleteModel model, CancellationToken ct);
    }
}
