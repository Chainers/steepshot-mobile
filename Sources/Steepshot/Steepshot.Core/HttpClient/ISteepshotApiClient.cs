...
namespace Steepshot.Core.HttpClient
{
    public interface ISteepshotApiClient
    {
        ...
        /// </summary>
        Task<OperationResult<LoginResponse>> LoginWithPostingKey(LoginWithPostingKeyRequest request, CancellationTokenSource cts);
        ...
        ///            Cookie: sessionid=h0loy20ff472dzlmwpafyd6aix07v3q6
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetUserRecentPosts(UserRecentPostsRequest request, CancellationTokenSource cts);
        ...
        ///             {"identifier":"/cat1/@joseph.kalu/cat636206825039716128"}
        /// </summary>
        Task<OperationResult<VoteResponse>> Vote(VoteRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<FollowResponse>> Follow(FollowRequest request, CancellationTokenSource cts);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/post/@joseph.kalu/cat636203355240074655/comments HTTP/1.1
        /// </summary>
        Task<OperationResult<GetCommentResponse>> GetComments(InfoRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<CreateCommentResponse>> CreateComment(CreateCommentRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<SearchResponse<SearchResult>>> GetCategories(SearchRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<LogoutResponse>> Logout(LogoutRequest request, CancellationTokenSource cts);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/user/joseph.kalu/info HTTP/1.1
        /// </summary>
        Task<OperationResult<UserProfileResponse>> GetUserProfile(UserProfileRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<UserFriendsResponse>> GetUserFriends(UserFriendsRequest request, CancellationTokenSource cts);
        ...
        /// </summary>
        Task<OperationResult<Post>> GetPostInfo(InfoRequest request, CancellationTokenSource cts);

        /// <summary>
        ///     Examples:
        ///     1) GET GET https://steepshot.org/api/v1/user/search?offset=gatilaar&limit=5&query=aar HTTP/1.1
        /// </summary>
        Task<OperationResult<SearchResponse<UserSearchResult>>> SearchUser(SearchWithQueryRequest request, CancellationTokenSource cts);
        ...
        Task<OperationResult<FlagResponse>> Flag(FlagRequest request, CancellationTokenSource cts);
    }
}