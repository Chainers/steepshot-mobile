...
namespace Steepshot.Core.HttpClient
{
    public interface ISteepshotApiClient
    {
        ...
        /// </summary>
        Task<OperationResult<LoginResponse>> LoginWithPostingKey(LoginWithPostingKeyRequest request);
        ...
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetUserPosts(UserPostsRequest request);
        ...
        ///            Cookie: sessionid=h0loy20ff472dzlmwpafyd6aix07v3q6
        /// </summary>
        Task<OperationResult<UserPostResponse>> GetUserRecentPosts(UserRecentPostsRequest request);
        ...
        /// </summary>
        Task<OperationResult<SearchResponse<VotersResult>>> GetPostVoters(InfoRequest request);
        ...
        ///             {"identifier":"/cat1/@joseph.kalu/cat636206825039716128"}
        /// </summary>
        Task<OperationResult<VoteResponse>> Vote(VoteRequest request);
        ...
        /// </summary>
        Task<OperationResult<FollowResponse>> Follow(FollowRequest request);
        ...
        /// </summary>
        Task<OperationResult<ImageUploadResponse>> Upload(UploadImageRequest request);
        ...
        /// </summary>
        Task<OperationResult<LogoutResponse>> Logout(LogoutRequest request);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/user/joseph.kalu/info HTTP/1.1
        /// </summary>
        Task<OperationResult<UserProfileResponse>> GetUserProfile(UserProfileRequest request);
        ...
        /// </summary>
        Task<OperationResult<UserFriendsResponse>> GetUserFriends(UserFriendsRequest request);

        /// <summary>
        ///     Examples:
        ///     1) GET https://steepshot.org/api/v1/tos HTTP/1.1
        /// </summary>
        Task<OperationResult<TermOfServiceResponse>> TermsOfService();
