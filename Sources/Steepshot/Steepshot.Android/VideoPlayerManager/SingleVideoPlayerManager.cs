...
{
    public class SingleVideoPlayerManager : IVideoPlayerManager<IMetaData>, IVideoPlayerManagerCallback, IMainThreadMediaPlayerListener
    {
        #region IVideoPlayerManager

        public void PlayNewVideo(IMetaData metaData, VideoPlayerView videoPlayerView, string videoUrl)
        {
            throw new NotImplementedException();
        }

        public void PlayNewVideo(IMetaData metaData, VideoPlayerView videoPlayerView, AssetFileDescriptor assetFileDescriptor)
        {
            throw new NotImplementedException();
        }
        ...
        public void SetCurrentItem(IMetaData currentItemMetaData, VideoPlayerView newPlayerView)
        {
            throw new NotImplementedException();
        }
        ...
        #endregion IVideoPlayerManager

        #region IVideoPlayerManagerCallback
        ...
        #endregion IVideoPlayerManagerCallback
