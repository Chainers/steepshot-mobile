...
namespace Steepshot.CustomViews
{
    public sealed class SelectableImageView : ImageView
    {
        ...
        private Paint SelectionPaint => _selectionPaint ?? (_selectionPaint = new Paint(PaintFlags.AntiAlias) { Color = Color.Rgb(255, 81, 4), StrokeWidth = BitmapUtils.DpToPixel(6, Context.Resources) });
